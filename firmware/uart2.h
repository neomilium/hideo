...
#define UART0_DEFAULT_BAUD_RATE		9600	/* /< default baud rate for
						 * UART0 */
#define UART1_DEFAULT_BAUD_RATE		9600	/* /< default baud rate for
						 * UART1 */

/* buffer memory allocation defines */
/* buffer sizes */
#ifndef UART0_TX_BUFFER_SIZE
#define UART0_TX_BUFFER_SIZE		0x0010	/* /< number of bytes for
						 * uart0 transmit buffer */
#endif
#ifndef UART0_RX_BUFFER_SIZE
#define UART0_RX_BUFFER_SIZE		0x0080	/* /< number of bytes for
						 * uart0 receive buffer */
#endif
#ifndef UART1_TX_BUFFER_SIZE
#define UART1_TX_BUFFER_SIZE		0x0010	/* /< number of bytes for
						 * uart1 transmit buffer */
#endif
#ifndef UART1_RX_BUFFER_SIZE
#define UART1_RX_BUFFER_SIZE		0x0080	/* /< number of bytes for
