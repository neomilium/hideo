...
void
drv_24lcxxx_read(const uint16 memory_address, const uint8 size, const void* data)
{
	byte _memory_address[2];
	// prepare address
...
void
drv_24lcxxx_write(const uint16 memory_address, const void* data, const uint8 size)
{
	byte _memory_address[2];
