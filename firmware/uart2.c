...
void 
uartSetRxHandler(u08 nUart, void (*rx_func) (unsigned char c))
{
	/* make sure the uart number is within bounds */
	if (nUart < 2) {
		/*
		 * set the receive interrupt to run the supplied user
		 * function
		 */
...
void 
uartSetBaudRate(u08 nUart, u32 baudrate)
{
...
void 
uartSendByte(u08 nUart, u08 txData)
{
...
u08 
uartReceiveByte(u08 nUart, u08 * rxData)
{
...
void 
uartFlushReceiveBuffer(u08 nUart)
{
...
u08 
uartReceiveBufferIsEmpty(u08 nUart)
{
	return (uartRxBuffer[nUart].datalength == 0);
}

void 
uartAddToTxBuffer(u08 nUart, u08 data)
{
...
void 
uart0AddToTxBuffer(u08 data)
{
	uartAddToTxBuffer(0, data);
}

void 
uart1AddToTxBuffer(u08 data)
{
	uartAddToTxBuffer(1, data);
}

void 
uartSendTxBuffer(u08 nUart)
{
...
u08 
uartSendBuffer(u08 nUart, char *buffer, u16 nBytes)
{
	register u08	first;
	register u16	i;
